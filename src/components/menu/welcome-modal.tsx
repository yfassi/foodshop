            ...
            <div className="mx-auto flex w-full max-w-md items-center justify-between gap-3">
              ...
              <div className="flex shrink-0 gap-2">
                <Link
                  ...
                  className="rounded-full px-3 py-1.5 text-xs font-semibold text-foreground transition-colors active:bg-muted"
                >
                  Connexion
                </Link>
                <Link
                  href={`/restaurant/${slug}/signup`}
                  className="rounded-full bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground transition-colors active:opacity-90"
                >
                  S&apos;inscrire
                </Link>
              </div>
